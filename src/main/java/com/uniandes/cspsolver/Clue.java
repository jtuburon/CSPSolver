...
public class Clue {
	...
	public final static String EQUIVALENCE_PATTERN="(?<relation>("+EQUIVALENCE_RELATIONSHIP + "))";
	public final static String VALUE_PATTERN="(?<value>\\d+)";
	
	public final static String SINGLE_RELATIONSHIP_PATTERN =VARIABLE_PATTERN + WHITESPACES_PATTERN + EQUIVALENCE_PATTERN + WHITESPACES_PATTERN + VALUE_PATTERN;
}
